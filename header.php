...
<body>
  ...
  <nav class=" indigo darken-3  bounceInDown wow" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="index.html" class="brand-logo"><img src="assets/img/Logo.png" class="logo-img fadeIn wow" ></a>
      ...
      <ul id="nav-mobile" class="side-nav  indigo darken-3 ">
        <li ><a class="white-text" href="index.php">HOME</a></li>
        <li ><a class="white-text" href="about.php">ABOUT US</a></li>
        <li ><a class="white-text" href="services.php">SERVICES</a></li>
        <li ><a class="white-text" href="gallery.php">GALLERY</a></li>
